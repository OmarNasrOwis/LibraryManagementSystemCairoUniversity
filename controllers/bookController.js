...
const createBook = async (req, res) => {
  ...
  try {
    await pool.query(
      "INSERT INTO books (title, author, publisher,barcode,isbn,availability, published_date) VALUES ($1, $2, $3, $4, $5, $6, $7)",
      [title, author, publisher, barcode, isbn, availability, published_date]
    );
